...
cd sdc11073_git 
echo "Starting sdc11073 consumer reference_client"
python3 -m examples.ReferenceTest.reference_client; ((test_exit_code = $?))
echo "Starting sdc11073 consumer test_client_connects"
python3 -m unittest examples.ReferenceTest.test_reference.Test_Reference._runtest_client_connects; ((test_exit_code = test_exit_code || $?))
